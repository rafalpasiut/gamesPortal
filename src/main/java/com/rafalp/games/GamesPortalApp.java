...
public class GamesPortalApp {

    private static final Logger log = LoggerFactory.getLogger(GamesPortalApp.class);

    private final Environment env;

    public GamesPortalApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes gamesPortal.
     * <p>

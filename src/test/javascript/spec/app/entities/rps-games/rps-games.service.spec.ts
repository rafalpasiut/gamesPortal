...
describe('Service Tests', () => {
    ...
    describe('RPSGames Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(RPSGamesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rps-games';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RPSGames', () => {

                let entity: RPSGames;
                service.find(123).subscribe((_entity: RPSGames) => {
                    entity = _entity;
                });
